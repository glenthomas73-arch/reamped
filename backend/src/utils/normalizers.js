...
const CONDITION_MAP = {
  ...
  // Guitar Center Used conditions
  'pristine': 'excellent', 'great': 'good', 'good - needs work': 'fair',
  // Sweetwater Used conditions
  'superb': 'excellent', 'great condition': 'good', 'good condition': 'good',
  'fair condition': 'fair',
  // Facebook Marketplace listing_condition values
  'used_like_new': 'excellent', 'used_good': 'good', 'used_fair': 'fair', 'used_poor': 'poor',
  // Gumtree condition words (parsed from ad body/title)
  'like new': 'excellent', 'barely used': 'excellent', 'lightly used': 'good',
  'well used': 'fair', 'needs repair': 'poor', 'spares': 'poor',
};
